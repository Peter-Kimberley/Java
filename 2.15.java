...
class Budget
{
   ...
   private int budget;      // the budget we can't exceed
   ...
   /**
    * setMeanCost finds a per unit cost based on a total cost 
    * and a number of units. As it uses integer division, 
    * it calculates only an approximate mean cost.
    */
    ...
    * and prints a message about whether the price is 
    * affordable for the budget or not.
    */
   ...
   // These extra getter (accessor) methods are provided. Do not alter them.
